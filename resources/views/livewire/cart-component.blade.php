						...
						<li class="pr-cart-item">
							...
							<div class="quantity">
								<div class="quantity-input">
									...
									<a class="btn btn-increase" href="#" wire:click.prevent="increaseQauntity('{{ $item->rowId }}')"></a>
									<a class="btn btn-reduce" href="#"  wire:click.prevent="decreaseQauntity('{{ $item->rowId }}')"></a>
								</div>
							</div>
...
{{-- 						
					  ...
					  @else
						<p> Votre panier est vide vide : ) </p>
					@endif
				</div>
