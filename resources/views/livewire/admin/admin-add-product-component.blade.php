		...
		<div class="container">
			...
			<div class="wrap-breadcrumb">
				<ul>
					...
					<li class="item-link"><span>Ajouter un produit </span></li>
				</ul>
			</div>
			<div class="row">
					...
					<div class=" main-content-area">
						<div class="wrap-login-item ">
							...
							@endif
								...
								<form name="frm-login" wire:submit.prevent="addProduct">
                                    ...
                                    <fieldset class="wrap-input" class="form-control">
                                     ...
                                     <fieldset class="wrap-input">
										...
										<input type="file" id="image" class="input-file form-control"   wire:model="image">
									    @if($image)
