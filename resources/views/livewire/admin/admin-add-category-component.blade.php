				...
				<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12 col-md-offset-3">
					<div class=" main-content-area">
						<div class="wrap-login-item ">
							...
							@endif
								<form name="frm-login" wire:submit.prevent="storeCategory">
									<fieldset class="wrap-title">
										<h3 class="form-title">Ajouter Une categorie</h3>										
									</fieldset>
									...
									<input type="submit" class="btn btn-submit" value="Ajouter" name="login">
